...
var SensorMlSocketIoCatalogItem = require('./SensorMlSocketIoCatalogItem');
...
var registerCatalogMembers = function() {
    ...
    createCatalogMemberFromType.register('sensormlsocketio', SensorMlSocketIoCatalogItem);
    createCatalogMemberFromType.register('terria-json', TerriaJsonCatalogFunction);
